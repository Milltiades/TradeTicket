...
export default function SecondSliderComponent() {
  ...
  return (
    <Main>
     ...
     <Slider {...settings} ref={sliderRef}>
      <div>
        <ContentDiv>
          <Content image={"/assets/content1.png"}>
            <Date>
              <DateP>
                {" "}
                08
          ...
          <Text>
            <TextH1>VINI VICI - Powered by Mono Hall Tbilisi</TextH1>
        ...
        <div>
        <ContentDiv>
          <Content image={"/assets/football.png"}>
            <Date>
              <DateP>
                {" "}
                25
            ...
            <Price>
              <PriceP1>From/</PriceP1>
              <PriceP2>$10.00</PriceP2>
            </Price>
          </Content>
          <Text>
            <TextH1>Football | Georgia - Mongolia
</TextH1>
        ...
        <div>  
          <ContentDiv>
          <Content image={"/assets/image6.png"}>
            <Date>
              <DateP>
                {" "}
                09
          ...
          <Text>
            ...
            <TextP1>Tbilisi, Vaso Abashidze Theater</TextP1>
